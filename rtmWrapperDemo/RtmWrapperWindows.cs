...
{
    public const string dll = "rtmCWrapper.dll";
    ...
    [DllImport(dll, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static extern int createRtmServiceInstance(string appId, SendMessageReceivedHandler smr, PeerMessageReceivedHandler pmr, LoginSuccessHandler lsc, LoginFailureHandler lfc, QueryStatusReceivedHandler qus, SubscriptionRequestHandler src, GetChannelMembersCountHandler gcmc);
